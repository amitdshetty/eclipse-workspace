...
public class Webpage {
	...
	/**
	 * Used to overload the getRedirect(Boolean secondRedirect) method if no Boolean
	 * is provided. By default, this will perform only one redirect and return the
	 * result.
	 * 
	...
	/**
	 * Used to get the URL that a page redirects to, or, optionally, the second
	 * redirect that a page goes to.
	 * 
	 * @param secondRedirect
	 *            "True" if the redirect should be followed twice }
