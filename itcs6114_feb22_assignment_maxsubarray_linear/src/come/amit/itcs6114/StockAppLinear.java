...
public class StockAppLinear {
	...
	public static void main(String[] args) {
		...
		PositionCalculatorLinear positionCalculatorLinear = new PositionCalculatorLinear();
		StockPositionBean stockPositionBean = positionCalculatorLinear.findMaximumSumLinear(priceDifference);
